			...
			<div data-step="1" data-intro= "@lang('help.login')"class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="{{ url('/auth/login') }}">
						...
						<div class="form-group">
							<div class="col-md-6 col-md-offset-4">
								<button data-step="4" data-intro= "@lang('help.entrar')" type="submit" class="btn btn-primary">@lang            ('login.login')</button>

								<a data-step="5" data-intro= "@lang('help.esquecerSenha')" class="btn btn-link" href="{{ url('/password/email') }}">@lang('login.forgot')</a>
							</div>
						</div>
					</form>
				</div>
